...
\begin{frame}{4769 Castalia reconstruction}
    \begin{center}
        \movie[width=0.8\textwidth,height=0.8\textheight,externalviewer]{\includegraphics[width=0.8\textwidth,height=0.8\textheight, keepaspectratio]{figures/castalia/partial_weights_2047.jpg}}{./videos/castalia.mp4}
\end{center}
\end{frame}
